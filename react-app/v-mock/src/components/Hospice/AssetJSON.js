...
export const AssetJSON = [
    {
        "name": "Connection and Conversation with Family (equipment)",
        "id": 1,
        "type": "Experience",
        "text": 
    ...
    {
        "name": "Decreased Perceived Constraints (potion)",
        "id": 4,
        "type": "Perspective",
    ...
    },
    {
        ...
        "type": "Education",
        "text": "",
        "benefit": "-X to Grandparent income",
    ...
    {
        "name": "John Deer Mobility Scooter 4x4",
        "id": 14,
        ...
        "benefit": "+X to Grandparent. Only available to grandparent level X or above.",
    ...
    },
    {
        ...
        "text": "Medicare part B will cover with doctor perscription \
            ...
            to pay 20%.",
        "benefit": "+X to Grandparent. Only available to grandparent with diabetes.",
        "source" : "https://www.medicare.gov/coverage/oxygen-equipment-accessories"
    }, 
    {
